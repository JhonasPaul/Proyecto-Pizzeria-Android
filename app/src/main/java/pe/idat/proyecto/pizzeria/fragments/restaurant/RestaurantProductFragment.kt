 ...
 * Use the [RestaurantProductFragment.newInstance] factory method to
...
class RestaurantProductFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RestaurantProductFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RestaurantProductFragment().apply {
